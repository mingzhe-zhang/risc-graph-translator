...
for i in dirlist:
    ...
    ret = os.system('copy ' +os.path.dirname(os.path.abspath(__file__))+'\\bincode_gener1.0\\structure_gen\\'+i+'\\dram_data_addr.txt '+os.path.dirname(os.path.abspath(__file__))+'\\TILE\\'+i+'\\dram_data_addr.txt')    
    if ret == 0:
        print(ret)
    else:
        print(ret)
