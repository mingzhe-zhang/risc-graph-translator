...
//-------------------------------------------------------------
	...
	initial begin
		...
		$readmemh("./case/<replace>/TILE/tile1/dram_data.txt", dram_data_file_2);
		$readmemh("./case/<replace>/TILE/tile1/dram_data_addr.txt", dram_addr_file_2);
		$readmemh("./case/<replace>/TILE/tile1/sram_code.txt", sram_data_file_2);
		$readmemh("./case/<replace>/TILE/tile1/sram_code_addr.txt", sram_addr_file_2);
		$readmemh("./case/<replace>/TILE/tile2/dram_data.txt", dram_data_file_3);
		$readmemh("./case/<replace>/TILE/tile2/dram_data_addr.txt", dram_addr_file_3);
		$readmemh("./case/<replace>/TILE/tile2/sram_code.txt", sram_data_file_3);
		$readmemh("./case/<replace>/TILE/tile2/sram_code_addr.txt", sram_addr_file_3);
		$readmemh("./case/<replace>/TILE/tile3/dram_data.txt", dram_data_file_4);
		$readmemh("./case/<replace>/TILE/tile3/dram_data_addr.txt", dram_addr_file_4);
		$readmemh("./case/<replace>/TILE/tile3/sram_code.txt", sram_data_file_4);
		$readmemh("./case/<replace>/TILE/tile3/sram_code_addr.txt", sram_addr_file_4);
